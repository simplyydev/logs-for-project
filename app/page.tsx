    ...
    <main className="container">
      ...
      <section className="hero">
        <div>
          ...
          <div className="sub">Public view shows redacted operational activity. Admins get full visibility after login.</div>
        </div>
        <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
          <LivePill />
          <Link href="/login" className="button primary">Admin Login</Link>
          <Link href="/admin" className="button ghost">Admin Panel</Link>
        </div>
      </section>
      ...
      <section className="panel">
        ...
        {loading ? <div className="notice">Loading public logs…</div> : null}
        <div className="cards">
          {logs.map((log) => (
